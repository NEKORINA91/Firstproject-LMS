...
namespace LeaveManagementSYstem
{
...

    {
        ...
        private string connectionString = @"Data Source=C:\Users\MIAbd\Desktop\PP assign whatttttt\LeaveManagementSYstem Provider=SQLNCLI11;
            Data Source=ABDULLAH\SQLEXPRESS;Integrated Security=SSPI;Initial Catalog=Leave_Management_System";
        private DataTable LeaveData = new DataTable();
        private void LeaveRequests_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dataSet2.LeaveReqs' table. You can move, or remove it, as needed.
            this.leaveReqsTableAdapter.Fill(this.dataSet2.LeaveReqs);
                ...
                // Populate leave balances when the form loads
        ...
        private void btnRequest_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString)) 
            {
                ...
                {
                    con.Open();
                    string query_LeaveAppply = "INSERT INTO LeaveReqs (LeaveID,EmployeeID,StartDate,EndDate,LeaveType,Status,Reason,AppliedDate,TotalDays)" +
                                          "VALUES (@LeaveID,@EmployeeID,@StartDate,@EndDate,@LeaveType,@Status,@Reason,@AppliedDate,@TotalDays)";
                    ...
                    using (SqlCommand cmd = new SqlCommand(query_LeaveAppply, con))
                    {
                        ...
                        if (endDate < startDate ) {
                            MessageBox.Show("End Date is before Start Date","Date Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
                        }
        ...
        private void CalculateTotalDays()
        {
            ...
            {
                totalDays = (int)(endDate - startDate).TotalDays + 1; // Include the end date
            }
        }
